-- ============================================================================
-- CONSOLIDATED MIGRATION SCRIPT FOR TARGETYM
-- ============================================================================
-- This script consolidates all migrations for deployment to Supabase online
...
-- ============================================================================
-- Migration: 20250109000000_5_create_helper_functions.sql
-- ============================================================================
-- ============================================================================
-- Migration: Helper Functions for RLS Policies
-- Created: 2025-01-09
-- Description: Essential utility functions used across RLS policies
-- ============================================================================
...
-- Migration Complete
COMMENT ON SCHEMA public IS 'Targetym HR Platform - Helper Functions for RLS v1.0';


-- ============================================================================
-- Migration: 20250109000000_create_complete_schema.sql
-- ============================================================================
-- ============================================================================
...
-- ============================================================================
-- Migration: 20250109000002_views_and_functions.sql
-- ============================================================================
-- ============================================================================
...
-- GRANT SELECT ON ALL VIEWS IN SCHEMA public TO authenticated; -- Commented: May cause errors if no views exist yet
...
-- ============================================================================
-- Migration: 20250109000003_enable_realtime.sql
-- ============================================================================
-- ============================================================================
...
-- ============================================================================
-- Migration: 20250109000004_add_ai_fields_candidates.sql
-- ============================================================================
...
CREATE INDEX IF NOT EXISTS idx_job_postings_created_by ON public.job_postings(created_by);
CREATE INDEX IF NOT EXISTS idx_job_postings_dates ON public.job_postings(posted_date, closing_date);
...
CREATE INDEX IF NOT EXISTS idx_interviews_date_status ON public.interviews(scheduled_date, status);
...
CREATE INDEX IF NOT EXISTS idx_reviews_cycle_status ON public.performance_reviews(review_cycle_id, status);

-- Feedback indexes
CREATE INDEX IF NOT EXISTS idx_feedback_employee ON public.feedback(employee_id);
CREATE INDEX IF NOT EXISTS idx_feedback_from_user ON public.feedback(from_user_id);
CREATE INDEX IF NOT EXISTS idx_feedback_type ON public.feedback(type);

-- Review Cycles indexes
CREATE INDEX IF NOT EXISTS idx_review_cycles_org_status ON public.review_cycles(organization_id, status);
...
COMMENT ON INDEX idx_reviews_cycle_status IS 'Optimize review cycle queries';


-- ============================================================================
-- Migration: 20250109000006_rls_ai_features.sql
-- ============================================================================
...
-- ============================================================================
-- Migration: 20250109000007_enable_rls_all_tables.sql
-- ============================================================================
-- ============================================================================
...
CREATE POLICY perf_rev_select ON public.performance_reviews FOR SELECT USING (organization_id=public.get_user_organization_id() AND (reviewee_id=auth.uid() OR reviewer_id=auth.uid() OR public.has_any_role(ARRAY['admin','hr']) OR public.is_manager_of(auth.uid(),reviewee_id)));
CREATE POLICY perf_rev_insert ON public.performance_reviews FOR INSERT WITH CHECK (organization_id=public.get_user_organization_id() AND reviewer_id=auth.uid() AND (public.has_any_role(ARRAY['admin','hr']) OR public.is_manager_of(auth.uid(),reviewee_id)));
...
CREATE POLICY career_dev_select ON public.career_development FOR SELECT USING (organization_id=public.get_user_organization_id() AND (profile_id=auth.uid() OR mentor_id=auth.uid() OR public.has_any_role(ARRAY['admin','hr']) OR public.is_manager_of(auth.uid(),profile_id)));
...
CREATE POLICY career_dev_update ON public.career_development FOR UPDATE USING (organization_id=public.get_user_organization_id() AND (profile_id=auth.uid() OR mentor_id=auth.uid() OR public.has_any_role(ARRAY['admin','hr']) OR public.is_manager_of(auth.uid(),profile_id)));
...
-- ============================================================================
-- Migration: 20251010000001_create_cvs_storage_bucket.sql
-- ============================================================================
...
-- ============================================================================
-- Migration: 20251011000000_add_kpis_table.sql
-- ============================================================================
-- ============================================================================
...
-- ============================================================================
-- Migration: 20251011000001_kpis_rls_policies.sql
-- ============================================================================
-- ============================================================================
...
-- Function to check if user is in same department
CREATE OR REPLACE FUNCTION is_same_department(target_user_id UUID)
RETURNS BOOLEAN AS $$
  SELECT EXISTS (
    SELECT 1
...
-- ============================================================================
-- Migration: 20251012105148_add_settings_tables.sql
-- ============================================================================
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS public.user_settings (
  ...
  dashboard_widgets JSONB DEFAULT '[\goals\, \upcoming_interviews\, \pending_reviews\, \team_performance\]'::jsonb,
...
-- ============================================================================
-- Migration: 20251012120000_create_notifications_system.sql
-- ============================================================================
-- ============================================================================
